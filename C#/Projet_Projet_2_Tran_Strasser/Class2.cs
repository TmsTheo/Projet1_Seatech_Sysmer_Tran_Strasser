...
{
    public class ReliableSerialPort_2 : SerialPort
    {
        public ReliableSerialPort_2(string portName, int baudRate, Parity parity, int dataBits, StopBits stopBits)
        {
            PortName = portName;
            BaudRate = baudRate;
            DataBits = dataBits;
    ...
    public class DataReceivedArgs_2 : EventArgs
    {

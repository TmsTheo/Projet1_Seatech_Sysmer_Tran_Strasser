 ...
 * Author: TP-EO-1
 *
 * Created on 21 octobre 2020, 16:17
 */
...
#define STATE_TOURNE_LENTEMENT 16
#define STATE_TOURNE_LENTEMENT_EN_COURS 17

#define PAS_D_OBSTACLE 0
#define OBSTACLE_A_GAUCHE 1
#define OBSTACLE_A_DROITE 2
#define OBSTACLE_EN_FACE 3
#define OBSTACLE_A_GAUCHE_BCP 4
#define OBSTACLE_A_DROITE_BCP 4
